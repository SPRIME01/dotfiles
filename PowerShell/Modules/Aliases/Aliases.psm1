...
try {
    ...
    Set-Alias -Name testnewfunction -Value Test-NewFunction -Description "A test function to verify the Update-AliasesModule.ps1 script works correctly." -Scope Global -Force
...
Export-ModuleMember -Function Get-AliasHelp, Get-FileTree, Get-SecretKey, Set-ProjectRoot, Test-NewFunction, Update-EnvVars `
    -Alias aliashelp, filetree, gensecret, projectroot, testnewfunction, updateenv
