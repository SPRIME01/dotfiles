# filepath: /home/sprime01/dotfiles/PowerShell/Modules/Aliases/Aliases.psm1
...
try {
    . (Join-Path -Path `/home/sprime01/dotfiles/PowerShell/Modules/Aliases -ChildPath 'Find-Directory.ps1')
    . (Join-Path -Path `/home/sprime01/dotfiles/PowerShell/Modules/Aliases -ChildPath 'Find-Text.ps1')
    . (Join-Path -Path `/home/sprime01/dotfiles/PowerShell/Modules/Aliases -ChildPath 'Get-AliasHelp.ps1')
    . (Join-Path -Path `/home/sprime01/dotfiles/PowerShell/Modules/Aliases -ChildPath 'Get-FileSize.ps1')
    . (Join-Path -Path `/home/sprime01/dotfiles/PowerShell/Modules/Aliases -ChildPath 'Get-FileTree.ps1')
    . (Join-Path -Path `/home/sprime01/dotfiles/PowerShell/Modules/Aliases -ChildPath 'Get-GitStatus.ps1')
    . (Join-Path -Path `/home/sprime01/dotfiles/PowerShell/Modules/Aliases -ChildPath 'Get-NetworkConnections.ps1')
    . (Join-Path -Path `/home/sprime01/dotfiles/PowerShell/Modules/Aliases -ChildPath 'Get-ProjectList.ps1')
    . (Join-Path -Path `/home/sprime01/dotfiles/PowerShell/Modules/Aliases -ChildPath 'Get-SecretKey.ps1')
    . (Join-Path -Path `/home/sprime01/dotfiles/PowerShell/Modules/Aliases -ChildPath 'Get-SystemInfo.ps1')
    . (Join-Path -Path `/home/sprime01/dotfiles/PowerShell/Modules/Aliases -ChildPath 'Invoke-UpdateAliasesModule.ps1')
    . (Join-Path -Path `/home/sprime01/dotfiles/PowerShell/Modules/Aliases -ChildPath 'New-GitCommit.ps1')
    . (Join-Path -Path `/home/sprime01/dotfiles/PowerShell/Modules/Aliases -ChildPath 'Open-Explorer.ps1')
    . (Join-Path -Path `/home/sprime01/dotfiles/PowerShell/Modules/Aliases -ChildPath 'Set-OhMyPoshTheme.ps1')
    . (Join-Path -Path `/home/sprime01/dotfiles/PowerShell/Modules/Aliases -ChildPath 'Set-ProjectRoot.ps1')
    . (Join-Path -Path `/home/sprime01/dotfiles/PowerShell/Modules/Aliases -ChildPath 'Show-Json.ps1')
    . (Join-Path -Path `/home/sprime01/dotfiles/PowerShell/Modules/Aliases -ChildPath 'Stop-ProcessByPort.ps1')
    . (Join-Path -Path `/home/sprime01/dotfiles/PowerShell/Modules/Aliases -ChildPath 'Test-NewFunction.ps1')
    . (Join-Path -Path `/home/sprime01/dotfiles/PowerShell/Modules/Aliases -ChildPath 'Test-Port.ps1')
    . (Join-Path -Path `/home/sprime01/dotfiles/PowerShell/Modules/Aliases -ChildPath 'Update-AliasesModule-Function.ps1')
    . (Join-Path -Path `/home/sprime01/dotfiles/PowerShell/Modules/Aliases -ChildPath 'Update-AliasesModuleFunction.ps1')
    . (Join-Path -Path `/home/sprime01/dotfiles/PowerShell/Modules/Aliases -ChildPath 'Update-EnvVars.ps1')
...
try {
    ...
    Set-Alias -Name ohmyposhtheme -Value Set-OhMyPoshTheme -Description "Switch Oh My Posh themes dynamically" -Scope Global -Force
...
Export-ModuleMember -Function Find-Directory, Find-Text, Get-AliasHelp, Get-FileSize, Get-FileTree, Get-GitStatus, Get-NetworkConnections, Get-ProjectList, Get-SecretKey, Get-SystemInfo, Invoke-UpdateAliasesModule, New-GitCommit, Open-Explorer, Set-OhMyPoshTheme, Set-ProjectRoot, Show-Json, Stop-ProcessByPort, Test-NewFunction, Test-Port, Update-AliasesModule-Function, Update-AliasesModuleFunction, Update-EnvVars `
    -Alias finddir, grep, aliashelp, sizes, filetree, gs, netstat, projects, gensecret, sysinfo, updatealiases, gc, explore, ohmyposhtheme, projectroot, json, killport, testnewfunction, testport, aliasesmodule-function, aliasesmodulefunction, updateenv
